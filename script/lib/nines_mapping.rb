...
module NinesMapping
  ...
  GENRE_MAPPING = {
      ...
      'Humor' => ['parodies','Parodies, imitiations, etc', 'humor', 'political cartoons', 'comedies', 'farces', 'satires'],
      ...
      'Nonfiction' => ['outdoor books', 'Forests and forestry', 'botany', 'fires and fire prevention','Human anatomy', 'anatomy', 'arithmetic', 'natural history', 'medecine', 'science', 'astronomy'],
      ...
      'Photograph' => ['photographs', 'photography','portrait photographs', 'card photographs','wet collodion negatives', 'tintypes', 'photograph albums', 'photomontages', 'glass negatives'],
