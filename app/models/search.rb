  ...
  def self.role_field_names
    {
        ...
        'role_AUT' => { :display =>  'Author' , :search_field => 'search_author' },
        ...
        'role_EDT' => { :display =>  'Editor' , :search_field => 'search_editor' },
        ...
        'role_PBL' => { :display =>  'Publisher' , :search_field => 'search_publisher' },
