...
solr_url_for = { "staging" => "http://localhost:8989/solr", "quandu_production" => "http://sds.itc.virginia.edu:8080/nines-solr1.3", "quandu_staging" => "http://sds6.itc.virginia.edu:8080/nines-solr1.3" }
