...
solr_url_for = { "staging" => "http://localhost:8989/solr", "quandu_production" => "http://sds5.itc.virginia.edu:8080/nines-solr", "quandu_staging" => "http://sds6.itc.virginia.edu:8080/nines-solr" }
...
ExceptionNotifier.exception_recipients = %w(dw6h@cms.mail.virginia.edu nick@laiacona.com)
...
COLLEX_ENGINE_PARAMS = {
  ...
  :field_list => ["archive","date_label","genre","role_ART", "role_AUT", "role_EDT", "role_PBL", "role_TRL","source","thumbnail","title","alternative","uri","url", "exhibit_type", "license"],
